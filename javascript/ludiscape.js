...
if(typesite!="mobile"&&typesite!="phablet"){
...
if(localExec()){
$("#main").fadeIn();
$("#loadludi,#loadbloc").animate({marginLeft:"-100px",opacity:0},300);
setTimeout('$("#loadludi,#loadbloc").css("display","none")',400);
}else{
$("#main").fadeIn();
$("#loadludi,#loadbloc").animate({marginTop : "-100px",opacity: 0},800);
setTimeout('$("#loadludi,#loadbloc").css("display","none")', 900);
}
}
...
h='<div class="mat-shadows-a noslideobject topslideobject' +  obj.id + '" ' ;
...
h=h + ' src="fx/bulles/' + rond + '" ';
h=h + ' onclick="viewbulle(' + obj.id + ');" ';
h=h + ' onmouseover="viewbulle(' + obj.id + ');" ';
h=h + ' onmouseout="viewbulleoff(' +obj.id + ');" ';
h=h + omd;
h=h + ' />';
obj.objx=105 * zoom;
obj.objy=96 * zoom;
...
h=h + ' id="gameitem' + obj.id + '" class="bloc' + obj.id + ' gameitem' + obj.id + '" ';
h=h + ' src="' + obj.text + '" ';
h=h + ' />';
}
...
h += '<img style="float:left;height:100%;display:none;" ';
h += ' id="gamelife' + i + '" class="gamelife' + i + '" ';
h += ' src="' + srcImg + '" ';
h += ' />';
}
...
var stCeel='<tbody style="display:block;height:100%;" >';
stCeel += '<tr style="display:table;height:100%;" >';
stCeel += '<td style="text-align:center;height:100%;';
stCeel += 'vertical-align:middle;cursor:pointer;padding:5px;" >';
var styB='display:block;width:' + zW + '%;height:' + zH + '%;' + stC;
...
h += '<table ' + classCube + ' ';
h += ' onClick="selectCarreQuizz('+obj.id+',1,\'' + backcol + '\');" ';
h += ' style="left:0px;top:0px;' + styB + '" >';
h += stCeel + getTextCarreQuizz(obj.contenu2,obj.contenu7,obj.field2,0);
h += '</td></tr></tbody></table>';
if(obj.contenu6==2){
...
h += '<table ' + classCube+ ' ';
h += ' onClick="selectCarreQuizz('+obj.id+',2,\'' + backcol + '\');" ';
h += ' style="left:' + (zW + zbord) + '%;top:0px;' + styB + '" >';
h += stCeel + getTextCarreQuizz(obj.contenu3,obj.contenu7,obj.field2,1);
h += '</td></tr></tbody></table>';
if(obj.contenu6==3){
...
h += '<table ' + classCube + ' ';
h += ' onClick="selectCarreQuizz('+obj.id+',3,\'' + backcol + '\');" ';
h += ' style="left:0px;bottom:0px;' + styB + '" >';
h += stCeel + getTextCarreQuizz(obj.contenu4,obj.contenu7,obj.field2,2);
h += '</td></tr></tbody></table>';
if(obj.contenu6==4){
...
h += '<table ' + classCube + ' ';
h += ' onClick="selectCarreQuizz('+obj.id+',4,\'' + backcol + '\');" ';
h += ' style="left:' + (zW + zbord) + '%;bottom:0px;' + styB + '" >';
h += stCeel + getTextCarreQuizz(obj.contenu5,obj.contenu7,obj.field2,3);
h += '</td></tr></tbody></table>';
h += '</div>';
addToM(h);
recupDataObjectMem(obj,lastPage0);
...
globalCompteurDisplay='<b>' + MillisecondsToTimeForCompteur(ht) + '</b>';
$(".blocTimerCompteur").html(globalCompteurDisplay);
}
}
}
...
if(Variable1!=''){
x=x + "<Variable1><![CDATA[" + Variable1 + "]]></Variable1>";
}
if(Variable2!=''){
x=x + "<Variable2><![CDATA[" + Variable2 + "]]></Variable2>";
}
if(Variable3!=''){
x=x + "<Variable3><![CDATA[" + Variable3 + "]]></Variable3>";
}
if(Variable4!=''){
x=x + "<Variable4><![CDATA[" + Variable4 + "]]></Variable4>";
}
if(Variable5!=''){
x=x + "<Variable5><![CDATA[" + Variable5 + "]]></Variable5>";
}
if(Variable6!=''){
x=x + "<Variable6><![CDATA[" + Variable6 + "]]></Variable6>";
}
if(Variable7!=''){
x=x + "<Variable7><![CDATA[" + Variable7 + "]]></Variable7>";
}
if(Variable8!=''){
x=x + "<Variable8><![CDATA[" + Variable8 + "]]></Variable8>";
}
if(Variable9!=''){
x=x + "<Variable9><![CDATA[" + Variable9 + "]]></Variable9>";
}
if(Variable10!=''){
x=x + "<Variable10><![CDATA[" + Variable10 + "]]></Variable10>";
}
if(initExam==1){
for(var j=0; j < 200; j++){
if(collDiapoExam[j]==''&&j>2){
}else{
x=x + '<collDiapoExam>' + collDiapoExam[j] + '</collDiapoExam>';
x=x + '<collDiapoExamIdPage>' + collDiapoExamIdPage[j] + '</collDiapoExamIdPage>';
}
}
}
x=x + '</interactions>';
...
var ht=getBoite(obj);
h='';
h += '<div style="display:none;color:' + color + ';position:absolute;' +  obj.cssadd + cssPlus + '" class="unselectable haveflou unselectable bloc' + obj.id + '" unselectable="on" >';
...
h += ' class="LargePanelSide' + sens + ' LPanelSide" ';
...
h += '<img ';
h += ' id="starA' + obj.id + '" class="unselectable" ';
h += ' src="' + obj.text + '" ';
h += ' style="position:absolute;z-index:4;" />';
h += '<img ';
h += ' id="starB' + obj.id + '" class="unselectable" ';
h += ' src="' + obj.contenu2 + '" ';
h += ' style="position:absolute;z-index:4;" />';
h += '<img ';
h += ' id="starC' + obj.id + '" class="unselectable" ';
h += ' src="' + obj.contenu3 + '" ';
h += ' style="position:absolute;z-index:4;" />';
h += '<img ';
h += ' id="starD' + obj.id + '" class="unselectable" ';
h += ' src="data/starts.gif" ';
h += ' style="position:absolute;z-index:5;display:none;" />';
Ecran.innerHTML=Ecran.innerHTML + h;
zoomshowStart(obj);
setTimeout(function(){zoomshowA(obj.id);},1000);
}
...
if(mynoteStar>9||obj.option==0){
setTimeout(function(){zoomshowB(obj.id);},1000);
}else{
setTimeout(function(){playshow();},1000);
}
}
function zoomshowB(i){
playshow();
obj=CObjets[i];
var xb=parseInt((obj.getX() + 148) * zoom);
var yb=parseInt((obj.getY() - 2) * zoom);
var wb=parseInt(160 * zoom);
var hb=parseInt(146 * zoom);
...
if(mynoteStar>18||obj.option==0){
setTimeout(function(){zoomshowC(obj.id);},1000);
}else{
setTimeout(function(){playshow();},1000);
}
}
...
playshow();
obj=CObjets[i];
var xb=parseInt((obj.getX() + 303) * zoom);
var yb=parseInt((obj.getY() + 27) * zoom);
var wb=parseInt(156 * zoom);
var hb=parseInt(156 * zoom);
...
var xbC=parseInt((obj.getX() + 330) * zoom);
var ybC=parseInt((obj.getY() + 25) * zoom);
var wbC=parseInt(85 * zoom);
var hbC=parseInt(125 * zoom);
$("#starD" + obj.id).css("width", wbC + 'px').css("height", hbC + 'px');
$("#starD" + obj.id).css("left", xbC + 'px').css("top", ybC + 'px');
setTimeout(function(){playshow3();},1000);
}
function playshow(){
if(globalSound==1){
playSoundOne('data/tiiin.wav','data/tiiin.mp3');
}
}
function playshow3(){
if(globalSound==1){
playSoundOne('data/tiiin3.wav','data/tiiin3.mp3');
}
$("#starD" + obj.id).fadeIn();
}
var idIsoHero='';
...
var evolx=parseFloat(bottomX) + ((6) * Math.cos(angleHero));
var evoly=parseFloat(bottomY) + ((6) * Math.sin(angleHero));
...
nextGameTick=(new Date).getTime();
for(var i=0; i < CObjets_count; i++){
if(CObjets[i].type=='spriteobject'){
var obj=CObjets[i];
var deplace=parseInt(obj.contenu5);
var num=parseInt(obj.contenu2);
if(num!=4&&num!=5){
...
newX=(largEcranWidth-(obj.getW()/2));
}
if(num!=6){
flipRightSpriteObject(obj,1);
}
...
var b='<div id="divwindowsobjBarre" style="position:absolute;left:0px;top:0px;right:0px;';
...
if(obj.an==21){
$(sid).css("-ms-transform", "translateY(-500px)");
$(sid).css("transform", "translateY(-500px)");
$(sid).css("-webkit-transform", "translateY(-500px)");
...
h=h + ' src="http://www.cloudlearning.fr/shareresult/ex.php?t=' + obj.contenu3 + '&n=' + krNb(mynote.toString()) + '&p=' + recupParmDom(obj) + '&m=' + obj.contenu4 + '&a=' + obj.contenu5 + '&u=' + obj.url + '" ></iframe>';
h=h + '</div>';
}
Ecran.innerHTML=Ecran.innerHTML + h;
}
...
urlp='http://www.batisseurs-numeriques.fr/ludiscapesendresultsplease/exbilan' + extenLgProcess;
if(isHTTPSmessage()){
urlp='https://www.ludiscape.com/ludiscapesendresultsplease/exbilan' + extenLgProcess;
}
msend=netH(msend);
...
var urlp='http://www.batisseurs-numeriques.fr/ludiscapesendresultsplease/exbilan' + extenLgProcess;
if(isHTTPSmessage()){
urlp='https://www.ludiscape.com/ludiscapesendresultsplease/exbilan' + extenLgProcess;
}
if(globalidentsend==''){
...
var displayrep=rep;
var yrep=document.getElementById('input' + CObjets[i].id).value;
var ctrx=parseInt(CObjets[i].getX() - 18 );
...
if(callXapiScore==0){
callXapiScore=1;
if('function' == typeof(ludiscapeFinishActivity)){
...
var login='';
ludiscapeFinishActivity(login,activityId,title,success,duration,score_raw);
}
}
}
var callXapiEnd=0;
...
if('function' == typeof(ludiscapeFinishAll)){
ludiscapeFinishAll(login,activityId,title,duration,score_raw);
}
...
if('function' == typeof(ludiscapeFinishScreen)){
ludiscapeFinishScreen(login,activityId,pageId,title,duration,tempScore,tempScoreMax,tempAnnotations,tempBilanXML);
}
if(document.getElementById("linkParams")){
var obnote=document.getElementById("linkParams");
