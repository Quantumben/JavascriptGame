...
function findAPI(win){
	...
	try{
		...
		while ((win.API_1484_11 == null) && (win.parent != null) && (win.parent != win) && callAPI<5)
		{
		...
		while ((win.API == null) && (win.parent != null) && (win.parent != win) && callAPI<5)
		{
			win = win.parent;
...
function ScormStartCom(){
	setTimeout(function(){ScormStartComProcess();},3000);
}
...
function archivesInteractionsScorm(){
	...
	var timfull = 10;
	for(var i=0; i < QueueInteractions_count; i++){
		setTimeout('archivesInteractionsProcess('+i+');',timfull);
		timfull = timfull + 200;
	}

}

function archivesInteractionsProcess(i){
